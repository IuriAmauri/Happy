...
export default function Orphanage() {
  const imagesFolder = "http://localhost:5000/Resources/Images/";
    ...
    <div id="page-orphanage">
      ...
      <main>
        <div className="orphanage-details">
          <img src={ `${imagesFolder}${orphanage.images[activeImageIndex].path}` } alt={ orphanage.name } />
          ...
          <div className="images">
            { orphanage.images.map((image, index) => {
              return (
                ...
                >
                  <img src={ `${imagesFolder}${image.path}` } alt={ orphanage.name } />
                </button>
              );
            })}
          </div>
